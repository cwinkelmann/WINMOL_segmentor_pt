...
def build_parser():
    ...
    tile.add_argument("--amodal", action="store_true",
                      help="bridge occlusion gaps between stem fragments sharing an id, "
                           "so masks cover the whole trunk (scripts/amodal_stems.py)")
...
def main(argv=None):
    ...
    stats = sample_tiles(args.ortho, args.stems, args.aoi, args.out,
                         ...
                         quiet=args.quiet, amodal=args.amodal)
    print(stats)
    return 0
